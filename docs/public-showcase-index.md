...
This index maps private production/source repositories to public-safe showcase repositories.

Public showcases are portfolio artifacts. They are not production source mirrors and must not include credentials, customer data, raw exports, private logs, business-sensitive rules, or live implementation internals.

## Flagship Review Path

Start with these repositories for a fast employer review:
...
- [commerce-automation-workflows-showcase](https://github.com/shiny-a2/commerce-automation-workflows-showcase)
- [jeweltimeco-showcase](https://github.com/shiny-a2/jeweltimeco-showcase)
- [a2-watch-marketplace-showcase](https://github.com/shiny-a2/a2-watch-marketplace-showcase)

## Active Project Showcase Map
...
| Private source | Public showcase | Status |
|---|---|---|
| `a2-crm-plugin` | [a2-crm-operations-system](https://github.com/shiny-a2/a2-crm-operations-system) | Current flagship |
| `jeweltimeco-webapp` | [jeweltimeco-showcase](https://github.com/shiny-a2/jeweltimeco-showcase) | Current showcase |
| `javaherian-commerce-platform-planning` | [commerce-platform-modernization-showcase](https://github.com/shiny-a2/commerce-platform-modernization-showcase) | Current flagship |
| `a2-javaherian-watch-bazaar` | [a2-watch-marketplace-showcase](https://github.com/shiny-a2/a2-watch-marketplace-showcase) | Current flagship |
